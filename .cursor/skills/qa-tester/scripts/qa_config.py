...
Usage:
    python .cursor/skills/qa-tester/scripts/qa_config.py show          # List profiles
    python .cursor/skills/qa-tester/scripts/qa_config.py check         # Verify credentials
    python .cursor/skills/qa-tester/scripts/qa_config.py apply <name>  # Apply a profile
    python .cursor/skills/qa-tester/scripts/qa_config.py restore       # Restore backup
