...
All files under `.cursor/skills/auto-coder/references/`:
...
```powershell
python .cursor/skills/auto-coder/scripts/sync_spec.py
```

Then read the schedule file to get task statuses:
- Read `.cursor/skills/auto-coder/references/06-schedule.md`
...
1. **Read relevant spec** from `.cursor/skills/auto-coder/references/`:
