...
```powershell
python .cursor/skills/package/scripts/clean.py
```
...
python .cursor/skills/package/scripts/clean.py --execute

# Keep data and logs
python .cursor/skills/package/scripts/clean.py --execute --keep-data

# Skip secret sanitization
python .cursor/skills/package/scripts/clean.py --execute --no-sanitize
```
...
| Test artifacts | `.cursor/skills/test-skill/`, `test_data/chroma/` |
| Skill caches | `.cursor/skills/auto-coder/.spec_hash` |
