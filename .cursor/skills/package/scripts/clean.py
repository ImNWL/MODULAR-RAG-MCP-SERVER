...
Usage:
    python .cursor/skills/package/scripts/clean.py          # dry-run (show what would be deleted)
    python .cursor/skills/package/scripts/clean.py --execute # actually delete
    python .cursor/skills/package/scripts/clean.py --execute --keep-data  # keep data/ & logs/
"""
...
REPO_ROOT = Path(__file__).resolve().parents[4]  # .cursor/skills/package/scripts → repo root
...
REMOVE_DIRS: list[str] = [
    ...
    # Test data caches
    "test_data/chroma",
    # Cursor skill test artifacts
    ".cursor/skills/test-skill",
]
...
REMOVE_FILES: list[str] = [
    ...
    "secrets.yaml",
    # Skill caches
    ".cursor/skills/auto-coder/.spec_hash",
    # Config backups
